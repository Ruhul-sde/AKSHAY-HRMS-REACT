...
const EmployeeDetailsReport = ({ userData, setUserData }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        >
          <div className="bg-white rounded-3xl shadow-xl p-12 border border-gray-100">
            ...
            >
              Comprehensive employee information reports including personal details, 
              employment history, skills, certifications, and organizational data.
            </motion.p>
